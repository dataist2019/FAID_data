...
'Select Fiscal Years', float(df_filtered['Fiscal Year'].min()), float(df_filtered['Fiscal Year'].max()), (float(df_filtered['Fiscal Year'].min()), float(df_filtered['Fiscal Year'].max())))
